...
// 				<div className="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1.2fr]">
// 					<div>
...
// 							/>
// 							{/* <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-primary"><img src={logo.src || logo} alt="TRIOPATH logo" className="h-6 w-6 object-contain" /></span> */}
// 							<span className="text-lg font-bold tracking-[0.12em]">TRIOPATH</span>
// 						</Link>
// 						<p className="mt-5 max-w-xs text-sm leading-relaxed text-white/60">
// 							{siteConfig.tagline} Empowering professionals and connecting exceptional talent with
...
// 								<a href={`tel:${siteConfig.contact.usaPhone}`} className="hover:text-white">
...
// 							<li className="flex gap-3">
// 								<Phone className="mt-0.5 h-4 w-4 shrink-0 text-accent" />
// 								<a href={`tel:${siteConfig.contact.indiaPhone}`} className="hover:text-white">
	...
	return (
		<footer className="navy-gradient relative overflow-hidden text-white">
			...
			<div className="relative mx-auto max-w-[1400px] px-4 pb-6 pt-16 sm:px-6 lg:px-8">
				...
				<div className="flex flex-col gap-4 pt-6 text-xs text-white/40 sm:flex-row sm:items-center sm:justify-between">
					<p>
						Copyright © 2025 TRIOPATH Careers. All Rights Reserved.
					</p>
