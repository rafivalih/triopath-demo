...
export function Navbar() {
	...
	// Later this will be replaced with real auth.
	// ------------------------------------------------
	...
	<div className="flex items-center">
		<Link
			href={link.href}
			className={cn(
				'inline-flex h-8 items-center border-b-[1.5px] border-transparent text-[13px] font-medium leading-none transition-colors hover:text-accent',
				pathname === link.href ||
					(link.href !== '/' &&
		...
		<button
			...
			className="inline-flex h-8 items-center text-gray-400 transition-colors hover:text-gray-700 focus:outline-none"
										...
										>
											<div className="overflow-hidden rounded-2xl border border-border bg-transparent p-2 shadow-premium">
												...
												<button
													...
													className="group flex w-full items-start gap-3 rounded-xl p-3 text-left transition-colors hover:bg-secondary"
												>
													<span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent/10 text-accent">
										...
										>
											<div className="overflow-hidden rounded-2xl border border-border bg-white p-2 shadow-premium">
												...
												<button
													...
													className="flex w-full items-start gap-3 rounded-xl p-3 text-left transition-colors hover:bg-secondary"
												>
													<span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent/10 text-accent">
														<GraduationCap className="h-4 w-4" />
													</span>
	...
	<>
		<div className="flex w-full items-center justify-between">
			<Link
				...
				className="flex-1 py-3 text-left text-sm font-medium text-primary/80 hover:text-accent"
			>
				{link.label}
			</Link>
			...
			<button
				...
				className="flex items-center justify-center py-3 pl-3 text-primary/80"
				aria-label={`Open ${link.label} menu`}
				aria-expanded={
					openDropdown === link.label
				}
					...
					{link.dropdown.map((item) => (
						...
						>
							{item.label}
									...
									<Link
										href="/contact#contact-form"
										className=" mt-4 block rounded-xl bg-primary px-4 py-3 text-center text-sm font-semibold text-white"
									>
