...
// 											}
// 											className={cn(
// 												'inline-flex h-8 items-center text-[13px] font-medium leading-none transition-colors duration-200 hover:text-gray-700 focus:outline-none focus-visible:text-accent',
// 												pathname.startsWith(link.dropdown[0].href.split('/').slice(0, 2).join('/'))
// 													? 'text-accent'
// 													: 'text-gray-400',
// 											)}
...
// 									>
// 										<span className="slide-hover-label">Get Started</span>
// 									</Link>
// 								</div>
// 							</motion.div>
// 						)}
