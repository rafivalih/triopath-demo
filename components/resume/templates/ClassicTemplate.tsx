  ...
  return (
    ...
    >
      ...
      <header className="border-b border-black pb-1 mb-[1px] break-inside-avoid">
        ...
        {personal.jobTitle && (
          <p className="text-[11pt] uppercase text-black ">
            {personal.jobTitle}
          </p>
        )}
          ...
          <div className="flex flex-wrap items-center text-[10pt]  text-black ">
            {contactLinks.map((item, idx) => (
              <React.Fragment key={idx}>
                ...
                {idx < contactLinks.length - 1 && (
                  <span className="mx-1.5 font-normal text-black ">
                    |
                  </span>
                )}
              </React.Fragment>
      ...
      {personal.summary && (
        <section className="mb-[1px] break-inside-avoid border-b border-black pb-[3px]">
          <h2 className="text-[11.5pt] font-bold uppercase text-black ">
            PROFESSIONAL SUMMARY
          </h2>
          <p className="text-[10pt] leading-[1.25] text-black">
            {personal.summary}
          </p>
        </section>
      )}
      ...
      {certificates && certificates.length > 0 && (
        <section className="">
          <h2 className="text-[11.5pt] font-bold uppercase text-black pb-13px]">
            CERTIFICATIONS
          </h2>
          <div className=" text-[10pt] text-black">
            {certificates.map((cert, idx) => (
