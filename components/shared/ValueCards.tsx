...
const cards = [
	{
		...
		title: 'Mission',
		icon: Target,
		text: 'To empower every candidate with the clarity, tools, and connections needed to build a career that moves forward — regardless of their starting point.',
	},
	{
		id: 'vision',
		title: 'Vision',
		icon: Eye,
		text: 'A world where career growth is not left to chance, but guided by expertise, data, and genuine human mentorship at every step.',
	},
	{
		id: 'philosophy',
		title: 'Career Philosophy',
		icon: Compass,
		text: 'We believe careers are not ladders but paths — winding, personal, and full of opportunity. Our role is to help you navigate yours with intention.',
	},
	{
		id: 'approach',
		title: 'Our Approach',
		icon: Lightbulb,
		text: 'We combine AI-powered insights with human expertise. Data tells us where the opportunities are; people help you get there.',
	},
];
...
function TiltCard({
	...
	return (
		...
		>
			...
			>
				<div style={{ transform: 'translateZ(20px)' }} className="relative pointer-events-none">
...
export function ValueCards() {
	...
	return (
		<div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
			{cards.map((card) => (
				<TiltCard key={card.id} card={card} hovered={hovered} setHovered={setHovered} />
			))}
		</div>
	);
}
