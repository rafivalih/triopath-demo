...
// 							Over 330+ candidates have moved their careers forward with TRIOPATH. Here are some of
// 							their stories.
// 						</p>
// 					</Reveal>
// 				</div>
...
// 												<div>
// 													<p className="text-sm font-bold text-[#5368df]">{review.name}</p>
...
// 								</p>
// 								<ButtonLink href="/contact#contact-form" variant="white" className="mt-6">
...
// 				<div className="relative mx-auto mt-10 max-w-4xl px-4 text-center sm:px-6 lg:px-8">
// 					<Reveal>
// 						<p className="mb-4 text-sm font-semibold uppercase tracking-wider text-accent">
// 							Success Stories
// 						</p>
...
// 								{reviews.map((review) => (
// 									<StaggerItem key={review.id}>
// 										<div className="group relative h-full overflow-hidden rounded-2xl border-[1px] border-gray-300 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-premium">
// 											<BorderTrail
// 												className="bg-gradient-to-l from-gray-400 via-gray-500 to-transparent blur-[1px]"
// 												size={70}
// 												transition={{
...
// 												<ProofModal proof={review.proofUrl}>
// 													<span className="inline-flex cursor-pointer items-center gap-1 text-xs font-medium text-gray-500 transition-colors hover:text-accent">
// 														View Proof
...
// 											<div className="flex items-stretch">
// 												<div
// 													className={`flex w-[26%] min-w-[76px] shrink-0 items-center justify-center border-none bg-gradient-to-br p-5 ${review.accentColor}`}
// 												>
// 													<div className="flex aspect-square w-full max-w-[76px] items-center justify-center rounded-2xl border-none bg-white/15">
// 														<Image
// 															src={rating}
				...
				<div className="mx-auto max-w-7xl px-4 ">
					<div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
						{reviews.map((review) => (
							<div
								key={review.id}
								className="group relative h-full overflow-hidden rounded-2xl border-[1px] border-gray-300 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-premium"
							>
								<BorderTrail
									className="bg-gradient-to-l from-gray-400 via-gray-500 to-transparent blur-[1px]"
									size={70}
								...
								<div className="flex items-center justify-between border-b border-border px-5 py-4">
									...
									<ProofModal proof={review.proofUrl}>
										<span className="inline-flex cursor-pointer items-center gap-1 text-xs font-medium text-gray-500 transition-colors hover:text-accent hover:underline hover:scale-110">
											View Proof
											<ExternalLink className="h-3 w-3" />
										</span>
									</ProofModal>
					...
					<div className="mt-16 text-center max-w-7xl flex flex-col justify-center items-center">
						<div className="navy-gradient relative mx-auto max-w-5xl overflow-hidden rounded-3xl px-6 py-12 sm:px-12">
							<div className="pointer-events-none absolute left-1/4 top-0 h-64 w-64 rounded-full bg-accent/15 blur-3xl" />
							...
							<div className="relative max-w-6xl">
								...
								<p className="mx-auto mt-4 max-w-6xl text-white/60 text-sm sm:text-md">
									Join thousands of professionals who chose TRIOPATH to guide their next step.
								</p>
