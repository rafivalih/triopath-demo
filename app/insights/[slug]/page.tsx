        ...
        <div className="mx-auto max-w-[1200px] px-4 pb-8 pt-10 sm:px-6 sm:pb-16 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-x-5 gap-y-3 text-sm text-muted-foreground">
              <span className=" text-primary border-[1px] border-gray-300 p-[4px] rounded-lg  text-[17px]">{post.author}</span>
          ...
          <article className="rounded-3xl border border-border bg-white px-6 py-8 shadow-sm sm:px-10 sm:py-12 lg:px-16 lg:py-14">
            ...
            <div className="border-b border-border pb-8">
              ...
              <p className="mt-3 text-base leading-7 text-muted-foreground">
                Explore the key ideas, strategic frameworks, and career insights
                      ...
                      >
                        <div>
                          ...
                          <p className="mt-5 text-[17px] leading-8 text-muted-foreground">
                            A strong resume should reflect the language and
                            requirements used in the target job description.
                            Identifying relevant keywords helps candidates
                        ...
                        <div className="grid gap-4 p-6 sm:grid-cols-3">
                          <div className="rounded-xl border border-border bg-white p-5">
                            ...
                            <p className="mt-2 text-sm leading-6 text-muted-foreground">
                              Skills, experience, qualifications and keywords
                              are identified.
                            </p>
                          </div>
                          ...
                          <div className="rounded-xl border border-border bg-white p-5">
                            ...
                            <p className="mt-2 text-sm leading-6 text-muted-foreground">
                              Required skills, experience and role requirements
                              are analyzed.
                            </p>
                          </div>
                          ...
                          <div className="rounded-xl border border-border bg-white p-5">
                            ...
                            <p className="mt-2 text-sm leading-6 text-muted-foreground">
                              Matched skills, missing requirements and
                              experience gaps are highlighted.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            {relatedPosts.map((related) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="mt-3 line-clamp-2 font-bold text-primary">
                    {related.title}
                  </h3>
